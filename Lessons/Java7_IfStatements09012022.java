...
public class Java7_IfStatements09012022
{
    public static void main(String[] args)
    {
        /*
                   LOGICAL STATEMENTS
              the if statements evaluates a condition.
...
Write Java program that will accept three number and return the greater number.
Input:
number1: 4
number2: 8
number3: 1
...
The greatest number is: 8
        ...
        // second condition is the number1 is the greatest
        if (number1>number3)
        {
            if(number1>number3)
            {
        ...
        /*
        TASK
1. Write a Java program that will accept two number and chekc if two numbers are
qual or not.
...
3. if hour is greater than or equal to 3pm, greet with Good Evening
        */
        ...
        System.out.println("this programs greet you please enter the time as hour");
